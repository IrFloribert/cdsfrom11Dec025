...
public class Orientation {
    ...
    @Field("orientation_line_code")
    private String orientationLineCode;

    @Field("orientation_line_name")
    private String orientationLineName;

    @Field("orientation_status")
