...
// @RestController
// @RequestMapping("/api/v1/otraco/certificate/orientation/enable")
// @Tag(name = "Orientation")
// @RequiredArgsConstructor  // This will generate a constructor for final fields
// public class EnableOrientationController {
//     private final OrientationPayload orientationPayload;
//     private final OrientationEventHandler handler;

//     @Operation(summary = "Enable orientation")
//     @PutMapping(produces = MediaType.APPLICATION_JSON_VALUE)
//     public Mono<ResponseEntity<MessageResponse>> Enable(@Valid @RequestBody OrientationStatusCommand cmd) {
//         return orientationPayload.statusException(cmd).then(handler.enable(cmd))
//             .map(s -> ResponseEntity.ok(new MessageResponse(true, MapUtils.enable)))
